...
<!--&lt;!&ndash;          <b-table-column field="miner.name" label="Hotspot Name" v-slot="props" sortable>{{ props.row.informal_name }}&ndash;&gt;-->
<!--&lt;!&ndash;          </b-table-column>&ndash;&gt;-->

<!--&lt;!&ndash;          <b-table-column field="miner.reward_scale" label="Reward Scale" sortable v-slot="props">&ndash;&gt;-->
<!--&lt;!&ndash;            {{ props.row.reward_scale.toFixed(2) }}&ndash;&gt;-->
<!--&lt;!&ndash;          </b-table-column>&ndash;&gt;-->

<!--          <b-table-column field="rewards.dailyRewards" label="1d" sortable>-->
<!--&lt;!&ndash;            {{ props.row.rewards.dailyRewards }}&ndash;&gt;-->
<!--          </b-table-column>-->

<!--&lt;!&ndash;          <b-table-column field="miner.rewards.weeklyRewards" label="7d" sortable v-slot="props">&ndash;&gt;-->
<!--&lt;!&ndash;            {{ props.row.rewards.weeklyRewards }}&ndash;&gt;-->
<!--&lt;!&ndash;          </b-table-column>&ndash;&gt;-->

<!--&lt;!&ndash;          <b-table-column field="miner.rewards.monthlyRewards" label="30d" sortable v-slot="props">&ndash;&gt;-->
<!--&lt;!&ndash;            {{ props.row.rewards.monthlyRewards }}&ndash;&gt;-->
<!--&lt;!&ndash;          </b-table-column>&ndash;&gt;-->

<!--&lt;!&ndash;          <b-table-column field="miner.witnesses.count" label="Witnesses" sortable v-slot="props">&ndash;&gt;-->
<!--&lt;!&ndash;            {{ props.row.witnesses !== undefined ? props.row.witnesses.count : 0 }}&ndash;&gt;-->
<!--&lt;!&ndash;          </b-table-column>&ndash;&gt;-->
